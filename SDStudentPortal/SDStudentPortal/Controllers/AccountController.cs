...
namespace SDStudentPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private void send_mail(IdentityMessage message)
        {
            ...
            mail.From = new MailAddress("SDStudentPortalTemp@gmail.com");
            ...
            (ConfigurationManager.AppSettings["GmailUserName"], ConfigurationManager.AppSettings["GmailPassword"]);// Enter seders User name and password
            smtp.EnableSsl = true;
            smtp.Send(mail);
        }
        #endregion
